...
public class AulaRealizadaDAOImpl {
	...
	public void updateAulaRealizada(String callSid, String callDuration, Status status, DateTime startTime,
		...
		String sql = "UPDATE AulaRealizadaImpl set duracao_chamada_aula_realizada=" + callDuration
				+ ", status_chamada_aula_realizada='" + status + "', dt_inicio_chamada_aula_realizada='" + startTime
				+ "', dt_fim_chamada_aula_realizada='" + endTime + "', custo_chamada_aula_realizada=" + price
