...
<body>
	...
	<form:form action="../usuario/getUsuario"
	...
	<form:form action="../professor/showFormUpdateProfessor"
		modelAttribute="usuario" method="POST">
		<input type="submit" name="Editar" value="Editar">
	</form:form>

	<form:form action="../professor/inactivateProfessor"
		modelAttribute="usuario" method="POST">
		<input type="submit" name="Inativar" value="Inativar"
