		...
		<fieldset>
			...
			<div class="form-group">
		  		<label class="col-md-4 control-label">Sobrenome</label>  
		  			<div class="col-md-4 inputGroupContainer">
		  				<div class="input-group">
		  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		  				<form:input placeholder="Sobrenome" class="form-control" path="sobrenome_usuario" required="true" maxlength="45" value="${usuario.sobrenome_usuario}"/>
		    			</div>
		  			</div>
			</div>	
			...
			<div class="form-group">
		  		<label class="col-md-4 control-label">E-mail</label>  
		  			<div class="col-md-4 inputGroupContainer">
		  				...
		  				<form:input placeholder="E-mail" class="form-control" type="email" path="email_usuario" required="true" maxlength="45" value="${usuario.email_usuario}"/>
		    			</div>
		  			</div>
			</div>	
			...
			<div class="form-group">
		  		<label class="col-md-4 control-label">Senha</label>  
		  			<div class="col-md-4 inputGroupContainer">
		  				...
		  				<form:input placeholder="Senha" class="form-control" type="password" path="senha_usuario" id="txtNewPassword" required="true" maxlength="40" value="${usuario.senha_usuario}"/>
		    			</div>
		  			</div>
			</div>	
			...
			<div class="form-group">
		  		<label class="col-md-4 control-label">Confirme sua senha</label>  
		  			<div class="col-md-4 inputGroupContainer">
		  				<div class="input-group">
		  				<span class="input-group-addon"><i class="glyphicon glyphicon-asterisk"></i></span>
		  				<input placeholder="Confirme sua senha" class="form-control" type="password" id ="txtConfirmPassword" required value="${usuario.senha_usuario}"/>
		    			</div>
		  			</div>
			</div>							
			...
			<div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="radio">
                                <label>
                                    <form:radiobutton path="sexo_usuario" value="F" /> Feminino
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <form:radiobutton path="sexo_usuario" value="M" /> Masculino
                                </label>
                            </div>
                        </div>
                    </div>					
		  		...
		  		<label class="col-md-4 control-label">Data de nascimento</label>  
		  			<div class="col-md-4 inputGroupContainer">
						...
						<fmt:formatDate value="${usuario.data_nascimento_usuario}" var="altDateString" pattern="MM/dd/yyyy" />
		  				<input class="form-control" id="datepicker" name="datepicker" placeholder="dd/mm/aaaa" value="${dateString}" />
			...
			<div class="form-group">
		  		<label class="col-md-4 control-label">Telefone</label>  
		  			<div class="col-md-4 inputGroupContainer">
		  				...
		  				<form:input class="form-control" path="telefone_usuario" required="true" placeholder="DDDXXXXXXXX" maxlength="11" tittle="Número incluindo DDD, sem traços" value="${usuario.telefone_usuario}"/>
		    			</div>
		  			</div>
			</div>	
