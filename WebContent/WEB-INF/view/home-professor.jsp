...
<body>
	...
	<div id="container" class="well form-horizontal" style="height: 600px; position: relative;">
		
<h3>Bem-vindo, ${usuario.nome_usuario}.</h3>
<div style="position: absolute; bottom: 88%; right: 100px;">
<input type="checkbox" id="status" checked data-toggle="toggle" data-on="Online" data-off="Offline">
<input type='hidden' name='usuario' value='${online}' id='sessionVar'/>
</div>


<form:form action="online" modelAttribute="usuario" method="POST">
<br><br>
<input class="btn btn-primary" style="display: none" type="submit" name="Perfil" id="o">
</form:form>
		

<form:form action="../professor/showPerfilProfessor" modelAttribute="usuario" method="POST">
<br><br>
<input class="btn btn-primary" style="position: absolute; bottom: 50px; right: 100px;" type="submit" name="Perfil" id="teste" value="Meu perfil">
</form:form>
