	...
	<div id="wrapper">
		...
		<div id="container" class="well form-horizontal"
			style="height: 600px; position: relative; display: table; width: 100%;">
             ...
             <div style="width: 100%;"> <!-- 2nd Container -->   
            <!-- Bootstrap tabs -->
            <div style="float: left; width: 600px; margin: 10px;">
            <ul class="nav nav-tabs">
                <li><a data-toggle="tab" href="#lastclass">Last class</a></li>
                <li class="active"><a data-toggle="tab" href="#classscript">Class script</a></li>
            </ul>
			...
			<div id="controls">
				 <div id="info">
					<div id="client-name" style="display: none;"></div>
                     <b>Student:</b> <br><h2>${aulaRealizadaModel.aluno.nome_usuario}</h2>
				</div> 
